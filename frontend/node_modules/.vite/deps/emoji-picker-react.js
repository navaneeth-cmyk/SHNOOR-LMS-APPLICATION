...
var PickerDataContext = import_react.default.createContext({
  ...
  allEmojisByUnified: {},
  searchIndex: {},
  emojiByUnified: function emojiByUnified2() {
    return void 0;
  },
...
function PickerDataProvider(_ref) {
  ...
  var emojiByUnified3 = import_react.default.useCallback(function(unified) {
  ...
  return import_react.default.createElement(PickerDataContext.Provider, {
    value: _extends({}, data, {
      emojiByUnified: emojiByUnified3,
...
function useGetEmojisByCategory$1() {
  var _usePickerDataContext = usePickerDataContext(), emojiData = _usePickerDataContext.emojiData, emojiByUnified3 = _usePickerDataContext.emojiByUnified;
  var suggestedEmojisModeConfig = useSuggestedEmojisModeConfig();
  var _useUpdateSuggested = useUpdateSuggested(), suggestedUpdated = _useUpdateSuggested[0];
...
function ViewOnlyEmoji(_ref) {
  ...
  var _usePickerDataContext = usePickerDataContext(), emojiByUnified3 = _usePickerDataContext.emojiByUnified;
  var style = {};
  if (size) {
    style.width = style.height = style.fontSize = size + "px";
  }
  var emojiToRender = emoji ? emoji : emojiByUnified3(unified);
  if (!emojiToRender) {
    return null;
  }
...
function PreviewBody() {
  ...
  var emoji = emojiByUnified3((_previewEmoji$unified = previewEmoji == null ? void 0 : previewEmoji.unified) != null ? _previewEmoji$unified : previewEmoji == null ? void 0 : previewEmoji.originalUnified);
  var show = emoji != null && previewEmoji != null;
  return (0, import_react.createElement)(PreviewContent, null);
  function PreviewContent() {
    var defaultEmoji = variationPickerEmoji != null ? variationPickerEmoji : emojiByUnified3(previewConfig.defaultEmoji);
    if (!defaultEmoji) {
      return null;
    }
