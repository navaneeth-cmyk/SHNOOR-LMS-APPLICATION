                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                ...
                                <div style={{ position: 'relative', margin: '24px 0 8px' }}>
                                    ...
                                    <div style={{ position: 'relative', display: 'flex', justifyContent: 'center' }}>
                                        <span style={{ padding: '0 12px', background: '#fff', fontSize: '11px', fontWeight: 700, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '1px' }}>Or quickly with</span>
                                    </div>
                                </div>

                                {/* Google Sign In - Quick Registration as Student */}
                                <button
                                    type="button"
